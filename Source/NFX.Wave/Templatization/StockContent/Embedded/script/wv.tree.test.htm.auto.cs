...
namespace id_92363_template_371 
{

 ///<summary>
 /// Auto-generated from template
 ///</summary>
 public  class wv_tree_test : NFX.Templatization.Template<object, NFX.Templatization.IRenderingTarget, object>
 {

     protected override void DoRender()
     {
       base.DoRender();
        Target.Write( wv_tree_test._72_S_LITERAL_0 );

     }


     #region Literal blocks content
        private const string _72_S_LITERAL_0 = @"<!DOCTYPE html>
