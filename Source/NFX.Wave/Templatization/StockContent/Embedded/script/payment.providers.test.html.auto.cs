...
namespace id_25412_template_371 
{

 ///<summary>
 /// Auto-generated from template
 ///</summary>
 public  class payment_providers_test : NFX.Templatization.Template<object, NFX.Templatization.IRenderingTarget, object>
 {

     protected override void DoRender()
     {
       base.DoRender();
        Target.Write( payment_providers_test._49_S_LITERAL_0 );

     }


     #region Literal blocks content
        private const string _49_S_LITERAL_0 = @"<head>
