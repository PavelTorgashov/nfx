...
namespace id_75864_template_371 
{

 ///<summary>
 /// Auto-generated from template
 ///</summary>
 public  class wv_ruler_test : NFX.Templatization.Template<object, NFX.Templatization.IRenderingTarget, object>
 {

     protected override void DoRender()
     {
       base.DoRender();
        Target.Write( wv_ruler_test._7_S_LITERAL_0 );

     }


     #region Literal blocks content
        private const string _7_S_LITERAL_0 = @"<!DOCTYPE html>
