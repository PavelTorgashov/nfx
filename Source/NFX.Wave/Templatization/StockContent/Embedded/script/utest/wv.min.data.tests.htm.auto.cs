...
namespace id_84739_template_371 
{

 ///<summary>
 /// Auto-generated from template
 ///</summary>
 public  class wv_min_data_tests : NFX.Templatization.Template<object, NFX.Templatization.IRenderingTarget, object>
 {

     protected override void DoRender()
     {
       base.DoRender();
        Target.Write( wv_min_data_tests._42_S_LITERAL_0 );

     }


     #region Literal blocks content
        private const string _42_S_LITERAL_0 = @"<!DOCTYPE html>
...
<body>
   ...
   <h1>WAVE Data / RecordModel Lib Tests</h1>
    ...
    <script src=""wv.data.tests.js"" ></script>
