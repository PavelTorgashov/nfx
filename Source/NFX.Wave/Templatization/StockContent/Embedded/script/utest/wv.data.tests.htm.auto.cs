...
namespace id_41180_template_371 
{

 ///<summary>
 /// Auto-generated from template
 ///</summary>
 public  class wv_data_tests : NFX.Templatization.Template<object, NFX.Templatization.IRenderingTarget, object>
 {

     protected override void DoRender()
     {
       base.DoRender();
        Target.Write( wv_data_tests._23_S_LITERAL_0 );

     }


     #region Literal blocks content
        private const string _23_S_LITERAL_0 = @"<!DOCTYPE html>
