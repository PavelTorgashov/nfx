...
namespace id_27012_template_371 
{

 ///<summary>
 /// Auto-generated from template
 ///</summary>
 public  class wv_utest : NFX.Templatization.Template<object, NFX.Templatization.IRenderingTarget, object>
 {

     protected override void DoRender()
     {
       base.DoRender();
        Target.Write( wv_utest._21_S_LITERAL_0 );

     }


     #region Literal blocks content
        private const string _21_S_LITERAL_0 = @"<!DOCTYPE html>
